...
label = ttk.Label(root,text = "Student Details Updation")
...
submit = ttk.Button(root,text = 'Update Details',width=20,command =lambda:database.stud_ent(ename.get(),efname.get(),eroll.get(),eemail.get(),ephn.get(),eadd.get(),ecity.get()))
